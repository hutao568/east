...
def validate_data(gtFilePath, submFilePath,evaluationParams):
    ...
    """
    gt = rrc_evaluation_funcs.load_gt_json(gtFilePath,False)

    subm = rrc_evaluation_funcs.load_res_json(submFilePath,True)
...
def eval(gt_file, pred_file):
    p = {'g': gt_file, 's': pred_file}
