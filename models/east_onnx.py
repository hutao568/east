...
def resnet18(pretrained_model=True, **kwargs):
...
class East(nn.Module):
    def __init__(self, pretrained_model=True, text_scale=512):
        ...
        #self.unpool1 = nn.Upsample((48, 48), mode='bilinear') # to onnx 768x768
        #self.unpool2 = nn.Upsample((96, 96), mode='bilinear') # to onnx
        #self.unpool3 = nn.Upsample((192, 192), mode='bilinear') # to onnx
        self.unpool1 = nn.Upsample((30, 42), mode='bilinear') # to onnx 480x672
        self.unpool2 = nn.Upsample((60, 84), mode='bilinear') # to onnx
        self.unpool3 = nn.Upsample((120, 168), mode='bilinear') # to onnx
    ...
    def forward(self,images):
        ...
        geo_map = self.sigmoid2(geo_map) * self.text_scale
        ...
        F_geometry = torch.cat((F_score, geo_map, angle_map), 1)
